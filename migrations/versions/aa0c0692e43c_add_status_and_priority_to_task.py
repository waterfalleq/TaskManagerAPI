...
def upgrade() -> None:
    op.add_column('tasks', sa.Column('status', taskstatus, nullable=False, server_default='TODO'))
    op.add_column('tasks', sa.Column('priority', taskpriority, nullable=False, server_default='NONE'))
